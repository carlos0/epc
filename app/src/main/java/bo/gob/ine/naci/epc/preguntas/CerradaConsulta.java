...
public class CerradaConsulta extends PreguntaView {
    ...
    public CerradaConsulta(Context context, int id, int idSeccion, String cod, String preg, Map<Integer, String> opciones, Map<Integer, String> opcionesConsulta, int buttonsActive, ArrayList<Integer> filtro, String ayuda) {
