...
public class ValorTipo2 extends PreguntaView {
    ...
    public ValorTipo2(Context context, int id, int idSeccion, String cod, String preg, Map<Integer, String> opciones, int maxLength, int buttonsActive, String ayuda) {
