...
public class Cantidad extends PreguntaView {
    ...
    public Cantidad(Context context, int id, int idSeccion, String cod, String preg, int buttonsActive, String ayuda, final Boolean mostrarSeccion, String observacion) {
