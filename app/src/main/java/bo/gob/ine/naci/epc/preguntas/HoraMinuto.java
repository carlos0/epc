...
public class HoraMinuto extends PreguntaView {
    ...
    public HoraMinuto(final Context context, final int posicion, final int id, int idSeccion, String cod, String preg, int buttonsActive, String ayuda, final Boolean evaluar) {
