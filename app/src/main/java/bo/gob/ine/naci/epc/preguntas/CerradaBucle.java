...
public class CerradaBucle extends PreguntaView {
    ...
    public CerradaBucle(Context context, int id, int idSeccion, String cod, String preg, Map<Long, String> opciones, String codEsp, int buttonsActive, String ayuda) {
        ...
        seNiega.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
