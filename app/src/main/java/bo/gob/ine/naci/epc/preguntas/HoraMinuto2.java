...
public class HoraMinuto2 extends PreguntaView {
    ...
    public HoraMinuto2(Context context, final int posicion, int id, int idSeccion, String cod, String preg, int maxLength, int buttonsActive, String ayuda, final Boolean evaluar) {
