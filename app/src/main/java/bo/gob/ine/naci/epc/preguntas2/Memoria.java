...
public class Memoria extends PreguntaView implements View.OnClickListener {
    ...
    public Memoria(final Context context, final int posicion, final int id, int idSeccion, String cod, String preg, int maxLength, final Map<Integer, String> buttonsActive, String[] opciones, String ayuda, final Boolean evaluar, final Boolean mostrarSeccion, String observacion) {
