...
public class CerradaInformante extends PreguntaView {
    ...
    public CerradaInformante(Context context, int id, int idSeccion, String cod, String preg, Map<Long, String> opciones, String codEsp, int buttonsActive, String ayuda, final Boolean mostrarSeccion, String observacion) {
        ...
        noAplica.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Log.d("onclicc",String.valueOf(1));
    ...
    public void setEnabledRB(boolean flag) {
        Log.d("Clic",String.valueOf(flag));
