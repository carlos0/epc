...
public class CerradaInformante extends PreguntaView {
    ...
    public CerradaInformante(Context context, int id, int idSeccion, String cod, String preg, Map<Long, String> opciones, String codEsp, int buttonsActive, String ayuda) {
