...
public class Calendario extends PreguntaView {
    ...
    public Calendario(Context context, int id, int idSeccion, String cod, String preg, String[] prev, GregorianCalendar fechaContacto, String ayuda, final Boolean mostrarSeccion, String observacion) {
