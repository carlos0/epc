 ...
 * Created by uinf
 */
public class CatalogoDinamico extends PreguntaView implements View.OnClickListener{
    ...
    public CatalogoDinamico(final Context context, final int posicion, final int id, int idSeccion, String cod, String preg, Map<Integer, String> opciones, String catalogo, Map<Integer, String> buttonsActive , String codEsp, final int minLength, final int maxLength, int active, String ayuda, final Boolean evaluar) {
...
//            Log.d("RESPUESTA", resp);
    ...
    private void cargarListadoSeleccionado(String clave) {
        try {
            ...
            if(catalogo.equals("catalogo_direcciones")){
                ...
                if(valor.equals(clave)){
                    valores = c.obtenerListado(" AND UPPER(descripcion) LIKE '%" + clave.toUpperCase() + "%'");
                    valoresInicial=c.obtenerListado(" AND UPPER(descripcion) LIKE '%" + clave.toUpperCase() + "%' ");
                }else {
                    valores.clear();
                }
