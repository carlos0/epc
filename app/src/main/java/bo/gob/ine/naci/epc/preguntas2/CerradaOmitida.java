...
public class CerradaOmitida extends PreguntaView {
    ...
    public CerradaOmitida(Context context, int id, int idSeccion, String cod, String preg, Map<Integer, String> opciones, String codEsp, int buttonsActive, String ayuda, int idUpm, final Boolean mostrarSeccion, String observacion) {
