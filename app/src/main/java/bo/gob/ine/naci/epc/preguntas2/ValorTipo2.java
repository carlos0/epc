...
public class ValorTipo2 extends PreguntaView {
    ...
    public ValorTipo2(Context context, int id, int idSeccion, String cod, String preg, Map<Integer, String> opciones, int maxLength, int buttonsActive, String ayuda, final Boolean mostrarSeccion, String observacion) {
        ...
        resp.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ValorTipo2.this.estado = Estado.INSERTADO;
                setEnabledRB(true);
                resp.setTextColor(Color.BLUE);
        ...
        noAplica.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                ValorTipo2.this.estado = Estado.NOAPLICA;
                setEnabledRB(false);
        ...
        seNiega.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                ValorTipo2.this.estado = Estado.SENIEGA;
                setEnabledRB(false);
                resp.setTextColor(Color.BLACK);
                noAplica.setTextColor(Color.BLACK);
        ...
        noSabe.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                ValorTipo2.this.estado = Estado.NOSABE;
                setEnabledRB(false);
                resp.setTextColor(Color.BLACK);
                noAplica.setTextColor(Color.BLACK);
                seNiega.setTextColor(Color.BLACK);
